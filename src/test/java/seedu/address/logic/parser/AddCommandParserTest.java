...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB
                + EMAIL_DESC_BOB + TELEGRAM_HANDLE_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB + EMAIL_DESC_BOB + TELEGRAM_HANDLE_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseFailure(parser,
                validExpectedPersonString + MATRIC_NUMBER_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + MATRIC_NUMBER_DESC_AMY + EMAIL_DESC_AMY
                        + TELEGRAM_HANDLE_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + MATRIC_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + TELEGRAM_HANDLE_DESC_BOB, expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_MATRIC_NUMBER_BOB + EMAIL_DESC_BOB
                        + TELEGRAM_HANDLE_DESC_BOB, expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB + VALID_EMAIL_BOB
                        + TELEGRAM_HANDLE_DESC_BOB, expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                        + VALID_TELEGRAM_HANDLE_BOB, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_MATRIC_NUMBER_BOB + VALID_EMAIL_BOB
                        + VALID_TELEGRAM_HANDLE_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + MATRIC_NUMBER_DESC_BOB + EMAIL_DESC_BOB
                + TELEGRAM_HANDLE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_MATRIC_NUMBER_DESC + EMAIL_DESC_BOB
                + TELEGRAM_HANDLE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, MatricNumber.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB + INVALID_EMAIL_DESC
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + MATRIC_NUMBER_DESC_BOB
                        + EMAIL_DESC_BOB + TELEGRAM_HANDLE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
