...
public class ParserUtilTest {
    ...
    private static final String VALID_MATRIC_NUMBER = "A1234567Z";
    private static final String VALID_TELEGRAM_HANDLE = "rachrach23";
    ...
    public void parseTelegramHandle_validValueWithoutWhitespace_returnsTelegramHandle() throws Exception {
        TelegramHandle expectedTelegramHandleHandle = new TelegramHandle(VALID_TELEGRAM_HANDLE);
        assertEquals(expectedTelegramHandleHandle, ParserUtil.parseTelegramHandle(VALID_TELEGRAM_HANDLE));
    }
