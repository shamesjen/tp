...
public class CommandTestUtil {
    ...
    public static final String VALID_MATRIC_NUMBER_AMY = "A1111111Z";
    public static final String VALID_MATRIC_NUMBER_BOB = "B2222222Y";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_TELEGRAM_HANDLE_AMY = "amyamy01";
    public static final String VALID_TELEGRAM_HANDLE_BOB = "BigBoyBob";
    ...
    public static final String INVALID_MATRIC_NUMBER_DESC = " " + PREFIX_MATRIC_NUMBER
            + "12345678Z"; // matric number not starting with letter
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_MATRIC_NUMBER_AMY).withEmail(VALID_EMAIL_AMY).withTelegramHandle(VALID_TELEGRAM_HANDLE_AMY)
                .withTags(VALID_TAG_FRIEND).withAssignments("Test1").build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_MATRIC_NUMBER_BOB).withEmail(VALID_EMAIL_BOB).withTelegramHandle(VALID_TELEGRAM_HANDLE_BOB)
